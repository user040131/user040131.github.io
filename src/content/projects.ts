...
`,
    Soksak: `
Soksak은 Node.js를 기반으로 한 현대인의 도파민 과잉을 편지의 형태로 해결하기 위한 웹 애플리케이션입니다. 
` ,
    Soksak_Sum: `
Soksak은 Node.js를 기반으로 한 현대인의 도파민 과잉을 편지의 형태로 해결하기 위한 웹 애플리케이션입니다.
` ,
    Jjikmeok: `
찍먹은 사용자의 관심사와 활동 지역을 기반으로 새로운 취미나 원데이 활동을 찾아주는 서비스입니다. 어떤 취미가 자신에게 맞는지 고민하는 사람이 여러 활동을 부담 없이 탐색하고 체험할 수 있도록 만들었습니다.
`
};
